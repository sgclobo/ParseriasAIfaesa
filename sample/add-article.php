    ...
    <style>
        ...
        *::after {
        ...
        body {
            ...
            background:
                radial-gradient(880px 360px at 90% -10%, rgba(200, 151, 58, .13), transparent 62%),
                radial-gradient(1000px 420px at -15% 105%, rgba(26, 58, 92, .15), transparent 70%),
                var(--bg);
            color: var(--text);
            line-height: 1.7;
        }
        ...
        body::before {
            ...
            inset: 0;
            pointer-events: none;
            background: repeating-linear-gradient(90deg, rgba(26, 58, 92, .018) 0 1px, transparent 1px 16px);
            z-index: 0;
        }
        ...
        .form-card {
            ...
            border-radius: 6px;
            padding: 2rem;
            box-shadow: 0 16px 45px rgba(15, 35, 56, .1);
            animation: contentAppear .34s ease-out;
        }
        ...
        .btn-submit:hover {
            ...
            box-shadow: 0 10px 20px rgba(15, 35, 56, .18);
        }

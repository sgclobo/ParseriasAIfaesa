...
<link rel="icon" type="image/x-icon" href="assets/img/aifaesa.svg">
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        @media (min-width: 640px) { .topbar .topbar-sub { display: block; } }
        ...
        .topbar .btn-add:hover { background: var(--accent-light); }
        ...
        .sidebar-home i { font-size: 1rem; color: var(--accent); }
        ...
        .sidebar-del-modal.show { display: flex; }
        .sidebar-del-box {
            background: #fff;
            border-radius: 7px;
            padding: 1.8rem;
        ...
        .sidebar-del-box p { color: #5a5a5a; font-size: .9rem; margin: 0 0 1.4rem; }
        .sidebar-del-actions { display: flex; gap: .6rem; }
    </style>
</head>
<body>
    ...
    <main class="main" id="main">
        <div class="content-frame">
            ...
            <?php
                    ...
                    if (isset($article)) { $currentArticle = $article; }
                    include $contentFile;
                endif;
            else:
